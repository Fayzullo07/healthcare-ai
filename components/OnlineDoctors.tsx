...
const OnlineDoctors = () => {
    return (
        ...
        <Container>
            ...
            <section className="py-0 sm:py-0 md:px-0">
                        ...
                        <div className="w-full md:w-1/3 md:px-3" data-aos="fade-up" data-aos-delay="300">
                            <div className="w-full flex flex-col justify-between pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                <h1 className=" font-extrabold tracking-tight text-gray-900">
                                    <span className="text-4xl sm:text-4xl text-green-400">Online Doctors</span>
                                </h1>
                                <div>


                                    <p className=" text-base= text-black lg:text-xl w-72">You have the opportunity to receive advice and diagnoses from online meetings and real experts</p>
